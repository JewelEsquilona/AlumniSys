...
--
DELIMITER $$
CREATE TRIGGER `after_insert_2024-2025` AFTER INSERT ON `2024-2025` FOR EACH ROW BEGIN
    -- Insert a new record into 2024-2025_WS with the new Alumni_ID_Number and default Working_Status as NULL
